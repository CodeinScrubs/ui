...
export const docsNav: DocsNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Iran Map Picker", href: "/docs/components/iran-map-picker" },
      ...
      { title: "Status Button", href: "/docs/components/status-button" },
